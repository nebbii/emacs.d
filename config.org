...
#+begin_src emacs-lisp
  (use-package flycheck
    :ensure t
    :config
    ;; Do not enable Flycheck globally. It conflicts visually with Eglot/Flymake
    ;; and is noisy in terminal Emacs.
...
(use-package company
  ...
  ;; Terminal-friendly completion UI.
  ...
  ;; Optional: also bind C-TAB if your terminal supports it.
...
#+begin_src emacs-lisp
  ...
  ;; Terminal Java buffers: no live diagnostic UI.
