...
*** Quiet Flymake in terminal Emacs
#+begin_src emacs-lisp
  ;; Eglot uses Flymake for diagnostics.
  ;; In terminal Emacs, keep diagnostics available but reduce visual clutter.
  (unless (display-graphic-p)
    (with-eval-after-load 'flymake
      ;; Do not place diagnostic indicators in the fringe/margin.
      (setq flymake-fringe-indicator-position nil)

      ;; Do not constantly re-check while typing.
      (setq flymake-no-changes-timeout 1.5)
      (setq flymake-start-on-save-buffer t)

      ;; Remove warning/error underlines in terminal.
