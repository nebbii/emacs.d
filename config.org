...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load 'magit
    (defun my/magit-commit-create-no-hooks ()
      "Create a commit with Git hooks disabled."
      (interactive)
    ...
    (transient-append-suffix 'magit-commit "c"
      '("n" "Commit no hooks" my/magit-commit-create-no-hooks)))
#+end_src
...
#+begin_src emacs-lisp
  (use-package flycheck
    :ensure t
    :config
    ;; Enable Flycheck only where you actually want it.
    ...
    ;; Only check on mode enable and save, not while typing.
...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load 'eglot
    ...
    (add-to-list 'eglot-server-programs
                 '(java-mode . ("jdtls" "-data" "~/.cache/emacs-jdtls-workspace"))))

  (add-hook 'java-mode-hook 'eglot-ensure)

  ;; Eglot completion via company-capf.
...
#+begin_src emacs-lisp
  (use-package projectile
    ...
    (setq projectile-project-search-path
          '("~/Documents/" "~/Projects/" "~/Documents/projects/" "~/.emacs.d/"))
...
#+begin_src emacs-lisp
  (use-package vterm
    ...
    :config
    ;; Keep plenty of terminal history available inside vterm buffers.
...
#+begin_src emacs-lisp
  ...
  ;; Keep Magit using its own completion wrapper, which delegates correctly
  ;; to Ivy when ivy-mode is enabled.
  (use-package magit
    :after ivy
    :bind (("C-x g" . magit-status)
           ("C-x C-g" . magit-status))
...
#+begin_src emacs-lisp
  (use-package general
    ...
    (define-key evil-normal-state-map (kbd "<f12> p p") 'projectile-switch-project)
